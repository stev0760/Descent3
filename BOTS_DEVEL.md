...
**Status:** Matcen 0.8.0-dev — Phase 5.2 complete. Difficulty levels (Trainee/Rookie/Hotshot/Ace/Insane) with 7 scaling parameters. Phase 5.1: config-file bot roster, ship selection, `[BOT]` name prefix, `$servercaps` telnet command. All bot commands use `$` prefix. See `BOT_MANAGEMENT.md` for design rationale.
