...
**Status:** Matcen 0.8.14 — Hoard game mode. Scarcity-adaptive cash-in algorithm, portal-targeted carrier nav (Hoard + CTF), sticky carrier commitment, collection-first behavior.

Next milestone: Hoard tuning + Entropy objective behavior.
