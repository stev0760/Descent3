...
**Status:** Matcen 0.8.16-dev — CTF flag-chasing prioritization. HUNT suppression for ATTACK bots, carrier home-room immunity, fumble rush, flag combat interrupt.

Next milestone: 0.8.16 stable (pending CTF validation), then 0.9.0 (Phase 7 navigation overhaul).
