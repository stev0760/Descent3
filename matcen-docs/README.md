...
Design documents, reference material, and specifications for the Matcen multiplayer bot fork of Descent 3. These documents are the project's persistent knowledge base, referenced by both human developers and AI coding agents (`CLAUDE.md`, `GEMINI.md`) across sessions.

| Document | Purpose |
|----------|---------|
| [PLAN.md](PLAN.md) | Original design document and full phase roadmap |
