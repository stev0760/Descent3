...
sparse skeleton; a disconnected or unusable graph still falls through to the old path. This is in
test on abend2 and adds no new `$nav` toggle. The last validated release remains 0.9.11.
