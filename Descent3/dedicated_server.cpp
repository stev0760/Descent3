...
static const NavToggle Nav_toggles[] = {
    ...
    {"seam", "seamguard", nullptr, &Bot_seam_guard_enabled,
    ...
    {"runner", "flagrunner", nullptr, &Bot_dedicated_runner_enabled,
     ...
     false},
    {"curve", "curvehop", nullptr, &Bot_curve_handout_enabled,
     "curve-following via hand-out: fatter-clearance chord so the via hugs bends (isengard corkscrew fix)", false,
     false},
